...
class Record(object): ## record enhirates object with its whole propoerties 
    """Represents a record."""

class Respondent(Record): ## respondent enhirates record
...
class Pregnancies(Table):
    ...
    def Recode(self):
        for rec in self.records:
            ...
            # filtering
            try: ## heyya deh bet7seb el preg weight elli = her weight + el babe weight
